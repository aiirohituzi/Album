    ...
    <div class="modal modal-detailImage">
        ...
        <div class="modal-box">
            ...
            <div class="detailImage">
                <div v-if="clickedImageArray.length > 1" class="detail-left" @click="detailLeft()"><font style="font-size: 50pt;font-family: '굴림';"><</font></div>
                <img v-if="clickedImage != undefined" :src="imagePath(clickedImage)">
                <div v-if="clickedImageArray.length > 1" class="detail-right" @click="detailRight()"><font style="font-size: 50pt;font-family: '굴림';">></font></div>
            </div>
        </div>
    </div>
</div>
